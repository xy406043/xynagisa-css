<template>
  <div class="grid">
    <div>
      <div class="every-a">水池</div>
      <div class="every-1">
        <div class="share"></div>
      </div>
    </div>
    <div>
      <div class="every-a">trasition-delay 实现按钮动画</div>
      <div class="every-2">
    ...
    <div>
      <div class="every-a">正负旋转相消3D</div>
      <div class="every-3">
...
.grid {
  ...
  grid-template-columns: 400px 523px 400px;
}
.every-a:before {
  content: "\1F4A5";
}
